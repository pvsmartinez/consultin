...
function clinicToSnake(input: Partial<Omit<Clinic, 'id' | 'createdAt'>>): Record<string, unknown> {
  ...
  return {
    ...
    ...(defined(input.calendarVisibleDays)    && { calendar_visible_days:      input.calendarVisibleDays }),
    ...(defined(input.calendarDisplayStartTime) && { calendar_display_start_time: input.calendarDisplayStartTime }),
    ...(defined(input.calendarDisplayEndTime) && { calendar_display_end_time:   input.calendarDisplayEndTime }),
