...
export function mapClinic(r: Record<string, unknown>): Clinic {
  return {
    ...
    calendarVisibleDays:      (r.calendar_visible_days as number[] | null) ?? undefined,
    calendarDisplayStartTime: (r.calendar_display_start_time as string | null) ?? null,
    calendarDisplayEndTime:   (r.calendar_display_end_time as string | null) ?? null,
