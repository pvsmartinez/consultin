  ...
  return (
    <>
      ...
      <div className={`fixed right-0 top-0 h-full w-full max-w-2xl bg-[#fcfdfd] shadow-2xl flex flex-col border-l border-white/60 ${stacked ? 'z-[70]' : 'z-50'}`}>
        {/* Header */}
        <div className="border-b border-gray-200 bg-white/80 px-4 py-4 backdrop-blur-sm sm:px-6 sm:py-5">
            ...
            <form id="patient-drawer-form" onSubmit={handleSubmit}>
              <div className="mb-6 rounded-2xl border border-gray-200 bg-white px-4 py-4 shadow-sm">
                <div className="flex items-start justify-between gap-4 flex-wrap">
                  ...
                  <div className="w-full rounded-2xl border border-teal-100 bg-teal-50 px-3 py-2 text-left sm:w-auto sm:min-w-[150px] sm:text-right">
                  ...
                  <div className="sm:col-span-2 flex items-start gap-3 rounded-2xl border border-teal-200 bg-teal-50 px-4 py-3 text-sm">
                    ...
                    <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:shrink-0">
                      <button type="button"
                        ...
                        className="min-h-11 rounded-xl px-3 py-2.5 text-sm font-medium text-white transition-all active:scale-[0.99]"
                        style={{ background: 'linear-gradient(135deg, #0ea5b0 0%, #006970 100%)' }}>
                        Vincular
                      </button>
                      <button type="button" onClick={() => setCpfSuggestion(null)}
                        className="min-h-11 rounded-xl px-3 py-2.5 text-sm font-medium text-[#006970] transition hover:bg-white">
                        Ignorar
                      </button>
                    </div>
                  </div>
        ...
        <div className="flex flex-col gap-3 border-t border-gray-200 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-6">
          {error && <p className="text-sm text-red-600 sm:flex-1">{error}</p>}
          <div className="flex w-full flex-col gap-2 sm:ml-auto sm:w-auto sm:flex-row sm:items-center">
            <button type="button" onClick={onClose}
              className="min-h-11 rounded-xl px-4 py-2.5 text-sm text-gray-600 transition hover:bg-gray-100">
              Cancelar
            </button>
