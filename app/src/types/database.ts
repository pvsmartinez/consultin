  ...
  public: {
    Tables: {
      ...
      clinic_public_page: {
        ...
        Relationships: [
          {
            foreignKeyName: "clinic_public_page_clinic_id_fkey"
            columns: ["clinic_id"]
            isOneToOne: true
            referencedRelation: "clinics"
            referencedColumns: ["id"]
      ...
      clinic_staff_requests: {
        ...
        Relationships: [
          {
            foreignKeyName: "clinic_staff_requests_clinic_id_fkey"
            columns: ["clinic_id"]
            isOneToOne: false
            referencedRelation: "clinics"
            referencedColumns: ["id"]
      ...
      patient_import_jobs: {
        ...
        Relationships: [
          {
            foreignKeyName: "patient_import_jobs_clinic_id_fkey"
            columns: ["clinic_id"]
            isOneToOne: false
            referencedRelation: "clinics"
            referencedColumns: ["id"]
      ...
      patient_treatment_budgets: {
        ...
        Relationships: [
          {
            foreignKeyName: "patient_treatment_budgets_clinic_id_fkey"
            columns: ["clinic_id"]
            isOneToOne: false
            referencedRelation: "clinics"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "patient_treatment_budgets_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "user_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "patient_treatment_budgets_patient_id_fkey"
            columns: ["patient_id"]
            isOneToOne: false
            referencedRelation: "patients"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "patient_treatment_budgets_professional_id_fkey"
            columns: ["professional_id"]
            isOneToOne: false
            referencedRelation: "professionals"
            referencedColumns: ["id"]
      ...
      patient_treatments: {
        Row: {
          ...
          patient_id: string
          payment_status: Database["public"]["Enums"]["treatment_payment_status"]
        ...
        Relationships: [
          {
            foreignKeyName: "patient_treatments_budget_id_fkey"
            columns: ["budget_id"]
            isOneToOne: false
            referencedRelation: "patient_treatment_budgets"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "patient_treatments_clinic_id_fkey"
            columns: ["clinic_id"]
            isOneToOne: false
            referencedRelation: "clinics"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "patient_treatments_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "user_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "patient_treatments_professional_id_fkey"
            columns: ["professional_id"]
            isOneToOne: false
            referencedRelation: "professionals"
            referencedColumns: ["id"]
      ...
      public_booking_rate_limits: {
        ...
        Relationships: [
          {
            foreignKeyName: "public_booking_rate_limits_clinic_id_fkey"
            columns: ["clinic_id"]
            isOneToOne: false
            referencedRelation: "clinics"
            referencedColumns: ["id"]
      ...
      wa_platform_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "wa_platform_messages_platform_user_id_fkey"
            columns: ["platform_user_id"]
            isOneToOne: false
            referencedRelation: "wa_platform_users"
            referencedColumns: ["id"]
          },
        ]
      }
    ...
    Functions: {
      ...
      current_user_can_access_clinic: {
      ...
      generate_clinic_join_code: { Args: never; Returns: string }
      get_clinic_whatsapp_token: {
        Args: { p_clinic_id: string }
        Returns: string
      }
      get_public_clinic_page: { Args: { p_slug: string }; Returns: Json }
      get_startup_data: { Args: never; Returns: Json }
      get_user_id_by_email: { Args: { p_email: string }; Returns: string }
      normalize_patient_search: { Args: { value: string }; Returns: string }
    ...
    Enums: {
      ...
      treatment_payment_status: "pending" | "partial" | "paid"
